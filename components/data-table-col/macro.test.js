...
describe("data-table-col", () => {
  it("renders a <th> with the base class and default scope", () => {
    const { document } = render("data-table-col", { text: "Name" });
    const el = document.querySelector("th.data-table-col");
  ...
  it("appends params.classes", () => {
    ...
    expect(document.querySelector("th.data-table-col.table-col-numeric")).toBeTruthy();
  });

  it("contains no <style> or <script> tags", () => {
    const { html } = render("data-table-col", { text: "x" });
