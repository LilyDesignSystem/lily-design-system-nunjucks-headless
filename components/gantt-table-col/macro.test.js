...
describe("gantt-table-col", () => {
  it("renders a <th> with the base class and default scope", () => {
    const { document } = render("gantt-table-col", { text: "Name" });
    const el = document.querySelector("th.gantt-table-col");
  ...
  it("appends params.classes", () => {
    ...
    expect(document.querySelector("th.gantt-table-col.table-col-numeric")).toBeTruthy();
  });

  it("contains no <style> or <script> tags", () => {
    const { html } = render("gantt-table-col", { text: "x" });
