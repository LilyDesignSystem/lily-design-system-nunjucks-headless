...
describe("kanban-table-th", () => {
  it("renders a <th> with the base class and default scope", () => {
    const { document } = render("kanban-table-th", { text: "Name" });
    const el = document.querySelector("th.kanban-table-th");
  ...
  it("appends params.classes", () => {
    ...
    expect(document.querySelector("th.kanban-table-th.table-col-numeric")).toBeTruthy();
  });

  it("contains no <style> or <script> tags", () => {
    const { html } = render("kanban-table-th", { text: "x" });
