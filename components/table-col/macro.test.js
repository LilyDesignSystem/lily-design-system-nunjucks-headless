...
describe("table-col", () => {
  it("renders a <th> with the base class and default scope", () => {
    const { document } = render("table-col", { text: "Name" });
    const el = document.querySelector("th.table-col");
  ...
  it("appends params.classes", () => {
    ...
    expect(document.querySelector("th.table-col.table-col-numeric")).toBeTruthy();
  });

  it("contains no <style> or <script> tags", () => {
    const { html } = render("table-col", { text: "x" });
