...
describe("table-th", () => {
  it("renders a <th> with the base class and default scope", () => {
    const { document } = render("table-th", { text: "Name" });
    const el = document.querySelector("th.table-th");
  ...
  it("appends params.classes", () => {
    ...
    expect(document.querySelector("th.table-th.table-col-numeric")).toBeTruthy();
  });

  it("contains no <style> or <script> tags", () => {
    const { html } = render("table-th", { text: "x" });
